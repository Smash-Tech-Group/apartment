...
export default function LocationRide() {
  ...
  return (
    <WizardLayout
      ...
      subtitle="Share your pickup location and how many passengers your ride accommodates comfortably."
  ...
  <div className="rounded-2xl shadow-sm border border-gray-100 p-6 bg-white">
    <div className="flex items-center justify-between mb-4">
      <p className="text-sm font-semibold text-gray-800">Confirm Pickup Location</p>
