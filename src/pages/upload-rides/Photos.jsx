...
export default function PhotosRide() {
  ...
  function next() {
    ...
    navigate("/upload-rides/features");
  }

  return (
    <WizardLayout
      title="Showcase Your Ride"
      subtitle="Capture your ride’s best angles with up to five high-quality photos. Then, add the features that make it stand out."
    ...
    >
      <div className="max-w-[500px] mx-auto">
        <div className="flex py-5 ">
          ...
          <p className="mt-2 text-sm font-medium text-black">Upload Photos of Your Ride <span className="bg-[#FF7D011A]/10 rounded-full px-2 py-1.5">Max 5MB</span></p>
        </div>
        ...
        <div className="flex py-5 ">
          <img className="w-6 h-10 pr-1" src={Upload} />
          <p className="mt-2 text-sm font-medium text-black">Upload a Short Walkaround Video <span className="bg-[#FF7D011A]/10 rounded-full px-2 py-1.5">Max 20s</span></p>
        </div>
