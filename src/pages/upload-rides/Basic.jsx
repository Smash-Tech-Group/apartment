...
export default function BasicRide() {
  ...
  return (
    <WizardLayout
      ...
      subtitle="Select the ride type and provide details like seat count and comforts to accurately represent your ride."
    ...
    >
      <div className="max-w-[620px] mx-auto">
        <div className="grid grid-cols-3 gap-2 mb-6 max-[900px]:grid-cols-2 max-[520px]:grid-cols-1">
          {[
            { key: "sedan", label: "Sedan", icon: Studio },
            { key: "suv", label: "SUV", icon: Duplex },
            { key: "van", label: "Van", icon: Bungalow },
          ].map((t) => (
        ...
        <div className="max-w-[480px]  mx-auto rounded-2xl shadow-sm border border-gray-100 p-5">
          <p className="text-md font-semibold text-gray-700 mb-3">Provide Ride Information</p>
