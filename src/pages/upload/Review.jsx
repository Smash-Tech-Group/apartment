...
export default function Review() {
  ...
  function goNext() { navigate("/upload/complete"); }

  return (
    <WizardLayout
      title="Set Your Stay Price"
      subtitle="Set a fair and competitive rate that reflects your apartment's value."
    ...
    >
      <div className="max-w-[440px] mt-8 mx-auto">
        <div className="rounded-2xl shadow-sm border border-gray-100 p-6">
          <p className="text-sm font-medium text-gray-700 mb-4">Stay Price</p>
